<%-- 
    Document   : AddMoreCauHoi
    Created on : Mar 2, 2023, 11:20:12 PM
    Author     : Giang Minh
--%>
            ...
            $(document).ready(function () {
                $("#textInput").on("keyup", function () {
                    ...
                    if (text === null || $.isEmptyObject(text)) {
                        window.location = "addmore?mamon=${maMon}&&mabaithi=${maBaiThi}";
                    }
                    $.ajax({
                        url: "addmore?mamon=${maMon}&&mabaithi=${maBaiThi}", // pick which servlet to request data
                        data: {text: text},
                        type: "POST",
                        ...
                        <div class="table-title">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 float-right">
                                    <button type="submit" class="btn btn-outline-primary add-new float-right" name="add" value="add"><i class="fa fa-plus-circle"></i> Add</button>
                                </div>
                            </div>
                        </div>
