                ...
                <div class="tab-content m-t-15">
                    <div class="tab-pane fade show active">
                        <div class="card mx-auto" style="width: 500px;">
                            <form action="/EOS_Admin/createcauhoi" method="post" enctype="multipart/form-data">
                                <div class="card-header text-center font-weight-bold pt-2 bg-light"><h2>Tạo câu hỏi</h2></div>
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <label class="font-weight-semibold" for="mamon">Mã môn học</label>
                                        <select class="form-control" name="mamon">
                                            <c:forEach items="${listMonHoc}" var="mh">
                                                <option value="${mh.maMon}" ${mh.maMon == ch.maMon.maMon ? "selected" : ""}>${mh.tenMon}</option>
                                            </c:forEach>
                                        </select>
                                    </div>
                                    <div class="form-group">
