 ...
 * @author Giang Minh
 */
@WebServlet(name = "Create", urlPatterns = {"/createmonthi"})
public class Create extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            DAO dao = new DAO();
            boolean isCreated = dao.createNewMonThi(maMon, tenMon);
            utils.Functions.noty(request, isCreated, "Thêm mới môn thi");
        } catch (Exception e) {
            System.out.println("createbaithi: " + e.getMessage());
        }
