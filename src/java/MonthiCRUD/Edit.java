 ...
 * @author Giang Minh
 */
@WebServlet(name="Edit", urlPatterns={"/editmonthi"})
public class Edit extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        request.getRequestDispatcher("QuanLyBaiThi/DanhSachMonThi/Edit.jsp").forward(request, response);
    } 
    ...
    throws ServletException, IOException {
        ...
        DAO dao = new DAO();
        boolean isEdited = dao.editMonThi(maMon, tenMon);
        utils.Functions.noty(request, isEdited, "Thay đổi môn thi");
