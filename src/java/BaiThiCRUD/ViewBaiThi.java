 ...
 * @author Giang Minh
 */
@WebServlet(name = "ViewBaiThi", urlPatterns = {"/viewbaithi"})
public class ViewBaiThi extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            System.out.println("viewbaithi_doget" + e.getMessage());
        }
        request.getRequestDispatcher("QuanLyBaiThi/DanhSachBaiThi/View.jsp").forward(request, response);
    }
