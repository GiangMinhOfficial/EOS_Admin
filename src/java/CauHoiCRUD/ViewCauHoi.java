 ...
 * @author Giang Minh
 */
@WebServlet(name = "ViewCauHoi", urlPatterns = {"/viewcauhoi"})
public class ViewCauHoi extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("QuanLyBaiThi/DanhSachCauHoi/View.jsp").forward(request, response);
    }
