                ...
                <div class="tab-content m-t-15">
                    <div class="tab-pane fade show active">
                        <div class="card mx-auto" style="width: 500px;">
                            <form action="/EOS_Admin/editmonthi" method="post">
                                <div class="card-header text-center font-weight-bold pt-2 bg-light"><h2>Thay đổi môn thi</h2></div>
                                <div class="card-body">
                                    <div class="form-group">
                                        <label class="font-weight-semibold" for="MaMon">Mã môn:</label>
                                        <input type="text" class="form-control" name="mamon" placeholder="Mã môn" value="${mh.maMon.trim()}" readonly>
                                    </div>
                                    <div class="form-group">
                                        <label class="font-weight-semibold" for="TenMon">Tên môn:</label>
                                        <input type="text" class="form-control" name="tenmon" placeholder="Tên môn" value="${mh.tenMon}">
                                    </div>
